...
@interface VNBKeyboardAvoidingState : NSObject
...
@implementation UIScrollView (VNBKeyboardAvoidingAdditions)

- (VNBKeyboardAvoidingState*)keyboardAvoidingState {
    VNBKeyboardAvoidingState *state = objc_getAssociatedObject(self, &kStateKey);
    if ( !state ) {
        state = [[VNBKeyboardAvoidingState alloc] init];
...
- (void)TPKeyboardAvoiding_keyboardWillShow:(NSNotification*)notification
{
    ...
    VNBKeyboardAvoidingState *state = self.keyboardAvoidingState;
    ...
    if ( [self isKindOfClass:[VNBKeyboardAvoidingScrollView class]] ) {
...
@implementation VNBKeyboardAvoidingState
@end
